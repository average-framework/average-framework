...
{
    public class MenuItemSlider<T> : IMenuItem
    {
        ...
        public MenuItemSlider(string text, T minValue, T maxValue, T defaultValue, T step, Action<T> action, bool visible = true)
        {
